 ...
 */
class JiraInfrastructure private constructor(
    ...
    private val stackProvisioning: Future<ProvisionedStack> by lazy { provisionStack() }
    ...
    fun provisionStack(
        ...
        return executor.submitWithLogContext("provision stack") {
            StackFormula(
                investment = investment,
    ...
    class Builder constructor(
        ...
        fun build(): JiraInfrastructure = JiraInfrastructure(
            configs = configs,
    ...
    private class MysqlInfrastructure(
        private val stack: Future<ProvisionedStack>,
        override val subnet: String
    ) : Infrastructure {

        override fun close() {
            stack.get().release().get()
        }
